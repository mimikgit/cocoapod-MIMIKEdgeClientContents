# MIMIKEdgeClientContents

MIMIKEdgeClientContents service library can help you interact with the following mimik services:
...
mimik
```
https://github.com/mimikgit/cocoapod-MIMIKEdgeClientContents
```
